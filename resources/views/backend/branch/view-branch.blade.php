                                ...
                                <table id="example1" class="table table-bordered table-hover">
                                    ...
                                    @foreach($allData as $key=>$value)
                                        <tr>
                                            ...
                                            <td>{{($value->address)}}</td>
                                            <td>{{($value->branch_type)}}</td>
                                            <td>

                                                <a title="Edit" class="btn btn-sm btn-primary" href="{{route('branches.edit',$value->id)}}"><i class="fa fa-edit"></i></a>
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <form action="{{route('branches.delete',$value->id)}}" method="post">
                                                                    @csrf
